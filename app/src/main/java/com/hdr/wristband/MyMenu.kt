...
object MyMenu {
    ...
    val menus: List<String>
        get() = listOf(CLEAR_LOG, BIND_DEVICE, UNBIND_DEVICE, CONNECT_DEVICE, DISCONNECT, SYN_TIME, DECRYPT_FIRMWARE, OTA, GET_DEVICE_BATTERY, GET_DEVICE_INFO, GET_SPORT_DATA, GET_SLEEP_DATA, GET_HEART_RATE)
}